...
<template>
  ...
  type="text"
  placeholder="Search..."
  class="pl-10 pr-4 py-2 w-64 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent bg-gray-200"
/>
