        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div class="flex flex-col sm:flex-row gap-3">
            ...
            <div>
              ...
              <select id="timeRange" v-model="filters.timeRange" class="input-field bg-gray-200">
          ...
          <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
              <tr>
                ...
                <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">% of Total
                </th>
              </tr>
            </thead>
            ...
            <tfoot class="bg-gray-50">
              <tr>
                ...
                <td class="px-4 py-4 whitespace-nowrap text-sm font-bold text-gray-900">${{
                  orderStore.totalRevenue.toLocaleString() }}</td>
