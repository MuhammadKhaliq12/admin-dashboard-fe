            ...
            <table class="min-w-full divide-y divide-gray-200">
              <thead class="bg-gray-50">
                <tr>
                  ...
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Threshold
                  </th>
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                <tr v-for="product in productStore.lowStockProducts.slice(0, 5)" :key="product.id">
                  ...
                  <td class="px-4 py-4 whitespace-nowrap">
                    <span class="px-2 py-1 text-xs font-medium rounded-full" :class="product.inventory === 0
