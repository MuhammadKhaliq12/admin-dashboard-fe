        ...
        <div class="dashboard-card">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-xl font-semibold text-gray-800">${{ productStore.totalInventoryValue.toLocaleString() }}
              </p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input id="search" type="text" v-model="filters.search" placeholder="Search by name or description"
                class="input-field pl-10 bg-gray-200" />
            </div>
          </div>
          ...
          <div>
            ...
            <select id="category" v-model="filters.category" class="input-field bg-gray-200">
          ...
          <div>
            ...
            <select id="inventoryStatus" v-model="filters.inventoryStatus" class="input-field bg-gray-200">
              ...
              <tr>
                <th
                  ...
                  <div class="flex items-center">
                    Product
                    <svg v-if="filters.sortBy === 'name'" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1"
                      fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        :d="filters.sortOrder === 'asc' ? 'M5 15l7-7 7 7' : 'M19 9l-7 7-7-7'" />
                    </svg>
                  </div>
                </th>
                <th
                  ...
                  <div class="flex items-center">
                    Category
                    <svg v-if="filters.sortBy === 'category'" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1"
                      fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        :d="filters.sortOrder === 'asc' ? 'M5 15l7-7 7 7' : 'M19 9l-7 7-7-7'" />
                    </svg>
                ...
                <th
                  ...
                  <div class="flex items-center">
                    Price
                    <svg v-if="filters.sortBy === 'price'" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1"
                      fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        :d="filters.sortOrder === 'asc' ? 'M5 15l7-7 7 7' : 'M19 9l-7 7-7-7'" />
                    </svg>
                ...
                <th
                  ...
                  <div class="flex items-center">
                    Inventory
                    <svg v-if="filters.sortBy === 'inventory'" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1"
                      fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        :d="filters.sortOrder === 'asc' ? 'M5 15l7-7 7 7' : 'M19 9l-7 7-7-7'" />
                    </svg>
              ...
              <tr v-for="product in filteredProducts" :key="product.id">
                ...
                <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-900">
                  <template v-if="editingProduct && editingProduct.id === product.id">
                    <div class="flex items-center">
                      <input type="number" v-model="newInventoryCount" min="0"
                        class="input-field py-1 px-2 w-20 mr-2" />
                      <button @click="saveInventoryChanges" class="p-1 text-success-600 hover:text-success-800 mr-1">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                          stroke="currentColor">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                        </svg>
                      </button>
                      <button @click="cancelEdit" class="p-1 text-error-600 hover:text-error-800">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                          stroke="currentColor">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  ...
                  <template v-else>
                    {{ product.inventory }} <span class="text-xs text-gray-500">(Min: {{ product.alertThreshold
                      }})</span>
                  </template>
                </td>
                ...
                <!-- Status -->
                <td class="px-4 py-4 whitespace-nowrap">
                  <span class="px-2 py-1 text-xs font-medium rounded-full" :class="getInventoryStatusClass(product)">
                ...
                <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-500">
                  <template v-if="!(editingProduct && editingProduct.id === product.id)">
                    <button @click="startEditInventory(product)" class="text-primary-600 hover:text-primary-800 mr-3">
                      Update Inventory
                    </button>
                  </template>
                </td>
